...
# Slightly modified by CosmicDan for OMP kitchen
...
readonly CONSTS_SCRIPT="$TOOL_ROOT/vdexExtractor_constants.sh"
readonly VDEX_EXTRACTOR_BIN="$TOOL_ROOT/vdexExtractor"
